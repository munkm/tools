...
" KERNEL CALL
syn match cudaKernel display "<<<[^>]\+>>>"

" CUDA access extentions
syn keyword cudaAccess  __device__ __global__ __host__
syn keyword cudaAccess  __constant__ __shared__ __restrict__
syn keyword cudaAccess  __inline__ __align__ __thread__
syn keyword cudaAccess  __noinline__ __forceinline__
...
syn keyword cudaType    cudaError_t cudaEvent_t cudaDeviceProp cudaMemcpyKind
...
" FUNCTIONS
" DBC (user added)
syn keyword cudaFunction CudaCall CudaInsist
" memory copy/allocation
syn keyword cudaFunction cudaMalloc cudaMemcpy cudaFree
" memory synchronization functions
syn keyword cudaFunction __threadfence_block __threadfence __threadfence_system
" point synchronization functions
syn keyword cudaFunction __syncthreads
" atomic functions
syn keyword cudaFunction atomicAdd atomicSub atomicInc atomicDec atomicCAS
" warp vote functions
syn keyword cudaFunction __all __any __ballot
...
hi def link cudaKernel    Special
hi def link cudaAccess    cppAccess
