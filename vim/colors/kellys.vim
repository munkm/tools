...
if has("gui_running")
    hi  Comment        guifg=#87888b guibg=#232429 gui=italic
    hi  Cursor         guifg=#232429 guibg=#e1e0e5 gui=none
    hi  Constant       guifg=#d1c79e guibg=#232429 gui=none
    hi  CursorLine     guibg=#303132 gui=none
    hi  DiffAdd        guifg=#232429 guibg=#9ab2c8 gui=none
    hi  DiffChange     guifg=#232429 guibg=#d1c79e gui=none
    hi  DiffDelete     guifg=#67686b guibg=#232429 gui=none
    hi  DiffText       guifg=#9d0e15 guibg=#d1c79e gui=none
    hi  Folded         guifg=#232429 guibg=#67686b gui=none
    hi  Function       guifg=#a1c435 guibg=#232429 gui=none
    hi  IncSearch      guifg=#000000 guibg=#55ee55 gui=bold
    hi  MatchParen     guifg=#d1d435 guibg=#232429 gui=bold,underline
    hi  ModeMsg        guifg=#e1e0e5 guibg=#232429 gui=bold
    hi  Normal         guifg=#e1e0e5 guibg=#232429 gui=none
    hi  Pmenu          guifg=#232429 guibg=#9ab2c8 gui=none
    hi  PmenuSel       guifg=#232429 guibg=#62acce gui=bold
    hi  PmenuSbar      guifg=#232429 guibg=#232429 gui=none
    hi  PmenuThumb     guifg=#232429 guibg=#62acce gui=none
    hi  PreProc        guifg=#d1d435 guibg=#232429 gui=none
    "hi Search         guifg=#232429 guibg=#e1e0e5 gui=none
    hi  Search         guifg=Yellow  guibg=Red     gui=standout
    hi  Special        guifg=#9ab2c8 guibg=#232429 gui=none
    hi  SpecialComment guifg=#98acb6 guibg=#232429 gui=italic
    hi  SpellBad       guifg=#e1e0e5 guibg=#801015 gui=bold
    hi  Statement      guifg=#62acce guibg=#232429 gui=bold
    hi  StatusLine     guifg=#232429 guibg=#62acce gui=bold
    hi  StatusLineNC   guifg=#232429 guibg=#e1e0e5 gui=none
    hi  Todo           guifg=#e1e0e5 guibg=#9d0e15 gui=bold
    hi  Type           guifg=#e6ac32 guibg=#232429 gui=none
    hi  Underlined     guifg=#e1e0e5 guibg=#232429 gui=underline
    hi  Visual         guifg=#232429 guibg=#e1e0e5 gui=none
    hi  Wildmenu       guifg=#62acce guibg=#232429 gui=bold
else
    if &t_Co == 256
